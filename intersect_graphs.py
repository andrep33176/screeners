...
allocation=pd.read_csv('intersect.csv')
...
path="/home/andre/equities/intersect_graphs"
...
for e in tickers:
    ...
    ggsave(equity_plot,"intersect_graphs/"+e+" Equity.png")
    ggsave(roe_plot,"intersect_graphs/"+e+" ROE.png")
    ggsave(cash_flow_plot,"intersect_graphs/"+e+" Cash_Flow.png")
    ggsave(deb2plot,"intersect_graphs/"+e+" Deb2E.png")
