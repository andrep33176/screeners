...
#jstocks['DCF_Val']=stocks['DCF']/stocks['Market_Cap_Num']
...
stocks=stocks.sort(columns=['Diff','ROE','Profit_Margin','Debt_to_Earnings'],ascending=[0,0,0,1])

stocks=stocks[['Company','Ticker','Industry','Market_Cap','DCF','ROE','Debt_to_Earnings',\
...
stocks.to_csv('roe.csv',index=False)
t2=time.time()
print t2-t1
