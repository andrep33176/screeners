...
stocks['GN']=0.75*((stocks['EPS']*(stocks['Price']/stocks['P/B'])*22.5)**0.5)
...
stocks['Payout']=(stocks['GN']-stocks['Price'])/stocks['Price']
...
stocks.to_csv('stock_allocation.csv',index=False)
t2=time.time()
print t2-t1
