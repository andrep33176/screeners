...
stocks=stocks[stocks['Industry'].str.contains('Banks|Savings Institutions')]
...
stocks=stocks[(stocks['P/E']<11)|(stocks['P/E']=='N/A')]
stocks=stocks[(stocks['P/B']<=1.2)]
...
stocks=stocks[['Company','Ticker','Industry','Market_Cap','DCF','DCF_Val','ROE',\
		'P/B','P/E','P/S','EPS','Debt_to_Equity','Dividend_Yield','Profit_Margin',\
		'PEG','Cash_Flow','Cash_Flow_Num','Levered_Cash_Flow','CPS','Price','High']]
stocks=stocks[(stocks['DCF_Val']>1)|(stocks['Cash_Flow_Num']==1)]



stocks=stocks.drop('Industry',axis=1)
print stocks.shape

stocks.to_csv('banks.csv',index=False)
t2=time.time()
print t2-t1
